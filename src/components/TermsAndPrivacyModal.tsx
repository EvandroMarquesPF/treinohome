  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 bg-black/80 backdrop-blur-md animate-in fade-in duration-200">
      ...
      >
        ...
        {/* Tab Switcher */}
        <div className="px-6 pt-4 border-b border-zinc-800/80 bg-zinc-900/50 flex space-x-2 shrink-0">
          <button
        ...
        <div className="p-6 overflow-y-auto space-y-6 text-zinc-300 text-sm leading-relaxed scrollbar-thin scrollbar-thumb-zinc-700">
          {activeTab === 'terms' ? (
            <div className="space-y-6">
              ...
              <section className="space-y-2">
                <h3 className="text-base font-bold text-white flex items-center gap-2">
                  <span className="text-lime-400">2.</span> Uso da Plataforma e Conta
                </h3>
              ...
              <section className="space-y-2">
                <h3 className="text-base font-bold text-white flex items-center gap-2">
                  <span className="text-lime-400">3.</span> Gamificação, Pontuação e Conquistas
                </h3>
                <p className="text-zinc-400 text-xs sm:text-sm">
