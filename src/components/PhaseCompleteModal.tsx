...
export const PhaseCompleteModal: React.FC = () => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-fade-in">
      <div className="w-full max-w-sm bg-gradient-to-b from-white via-emerald-50/50 to-emerald-100/50 dark:from-zinc-900 dark:via-zinc-900 dark:to-emerald-950/40 border-2 border-emerald-400 rounded-3xl p-6 sm:p-8 space-y-6 text-center text-zinc-900 dark:text-zinc-100 shadow-2xl relative overflow-hidden transition-colors">
        ...
        <div className="space-y-2">
          ...
          <p className="text-sm font-bold text-emerald-600 dark:text-emerald-400">Você concluiu a {phaseCompleteModal.title}!</p>
          <div className="text-xs text-amber-700 dark:text-amber-400 font-extrabold bg-amber-400/20 py-1.5 px-3 rounded-full inline-block border border-amber-400/30">
        ...
        <button
          ...
          className="w-full py-3 rounded-2xl bg-gradient-to-r from-emerald-400 to-teal-400 text-zinc-950 font-black text-sm shadow-xl shadow-emerald-500/20 hover:scale-105 active:scale-95 transition-all flex items-center justify-center space-x-2 cursor-pointer"
        >
