  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/70 backdrop-blur-md animate-fade-in">
      <div className="w-full max-w-sm bg-gradient-to-b from-white via-amber-50/50 to-amber-100/50 dark:from-zinc-900 dark:via-zinc-900 dark:to-amber-950/40 border-2 border-amber-400 rounded-3xl p-6 sm:p-8 space-y-6 text-center text-zinc-900 dark:text-zinc-100 shadow-2xl relative overflow-hidden transition-colors">
        ...
        <div className="inline-flex items-center space-x-1.5 px-3 py-1 rounded-full bg-amber-400/20 border border-amber-400/40 text-amber-800 dark:text-amber-300 text-xs font-black animate-bounce">
        ...
        <div className="relative w-28 h-28 mx-auto flex items-center justify-center">
          ...
          <div className="relative w-full h-full rounded-full bg-white dark:bg-zinc-950 border-4 border-amber-400 text-amber-600 dark:text-amber-300 font-black text-4xl flex items-center justify-center shadow-2xl">
            Nível {levelUpModal.level}
          </div>
        </div>

        <div className="space-y-2">
          <h2 className="text-2xl font-black text-zinc-900 dark:text-white">Você Alcançou o Nível {levelUpModal.level}!</h2>
